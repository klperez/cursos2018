...
## Contenido | Cápitulo I - Estadística descriptiva. 

- Definición y ramas de la Estadística 
- Población y Muestra, Parámetro, estadística y estimación  
- Tipos y clasificación de variables
- Distribuciones de frecuencia 
- Estadísticas de resumen 
- Análisis exploratorio de datos 

## Contenido | Cápitulo II - Introducción a la probabilidad 

- Concepto de probabilidad 
- Calculo de probabilidades 
- Probabilidad condicional e independencia 
- Probabilidad total, regla de la multiplicación y teorema de Bayes 


## Contenido | Cápitulo III - Variables aleatorias 
...
## Contenido | Cápitulo IV - Distribuciones de probabilidad 

- Distribuciones discretas y continuas 
- Calculo de probabilidades en distribuciones 
- Vectores aleatorios 

## Contenido | Cápitulo V - Inferencia estadística 
